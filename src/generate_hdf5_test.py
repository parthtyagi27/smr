...
if __name__ == "__main__":
    ...
    li = generate_indices(step_q=8*(np.e/150), step_chi=np.e/100)
    chunk = 64  # Number of waveforms to generate on each rank at each iter [Limited by memory on the node]
