...
parser.add_argument('--checkpoint_dir', help='root directory', default='/home/ptyagi3/checkpoint/')
parser.add_argument('--data_dir', help='root directory', default='/home/ptyagi3/data/')
...
training_generator = Generator(shuffle=False, hvd_rank=hvd.rank(), hvd_size=hvd.size())
...
model.compile(opt, loss={'q_output': 'mean_squared_error', 'ap_output': 'mean_squared_error'}, experimental_run_tf_function=False)
